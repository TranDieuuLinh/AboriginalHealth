        ...
        <div class="flex flex-col w-screen mt-10 px-4 md:px-10">
          <div class="flex flex-col md:flex-row items-center">
            <div class="rotating-image">
              <img 
                class="w-[10em] md:w-[20em] mt-10" 
                src="../assets/fundLogo.png" 
                alt="Fund logo representing our mission" 
              />
            </div>
          ...
          >
            ...
            <div class="relative">
              <img :src="each.imageUrl" alt="Highlight from our success story" class="object-cover" />
...
:focus {
  outline: 3px solid #007BFF; /* Change color as needed */
}
</style>
